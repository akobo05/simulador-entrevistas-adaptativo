...
function ParticlesDot() {
  ...
  return (
    <points ref={ref}>
      ...
      {/* particulas en cian oscuro: visibles sobre fondo claro */}
...
export function OrbeAnimado() {
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      >
        {/* luz ambiente mas alta para que el orbe no quede oscuro sobre fondo claro */}
        ...
        {/* luz de borde: indigo para profundidad */}
        <pointLight position={[0, 5, -5]} intensity={1.0} color="#6366F1" />

        <OrbeCore />

        {/* anillos: azul, cian, indigo */}
