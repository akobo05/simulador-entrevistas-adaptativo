...
\input{secciones/00-tema-objetivo}
\input{secciones/01-stakeholders}
\input{secciones/02-stakeholders-discapacidad}
\input{secciones/03-requerimientos}
\input{secciones/04-cumplimiento-modulos}
\input{secciones/05-casos-de-uso}
\input{secciones/06-prompts-ia}
\input{secciones/07-entrevistas-usuarios}
\input{secciones/08-sistemas-similares}
\input{secciones/09-criterios-usabilidad}
\input{secciones/10-alternativas-diseno}
\input{secciones/11-diagrama-gantt}
\input{secciones/12-prototipo-fidelidad-media}
