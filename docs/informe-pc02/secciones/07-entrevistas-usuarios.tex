...
\begin{itemize}
  ...
  \item \textbf{Expectativas frente a la IA}:
        ...
        \end{itemize}
  \item \textbf{Metáfora del \textit{Warachikuy} y el aura}:
        \begin{itemize}
          \item Al imaginar un entorno de prueba ritualizada inspirado
                en el \textit{Warachikuy} inca, ¿qué elementos visuales
                consideraría motivadores?
